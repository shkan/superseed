...
local function run(msg, matches)
  if matches[1]:lower() == 'S.H.O.S' then -- Put everything you like :)
    local about = _config.about_text
    local name = user_print_name(msg.from)
    savelog(msg.to.id, name.." ["..msg.from.id.."] used /S.H.O.S ")
    return about
  end 
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "S.H.O.S" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) (S.H.O.S)",-- Put everything you like :)
		"^[!/](S.H.O.S)"-- Put everything you like :)
    }, 
  run = run
}
